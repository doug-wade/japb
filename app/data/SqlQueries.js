var sqlQueryDict = {
  ...
  'getUser': 'select pw_hash as "hash", username as "username", user_id as "user_id", access_level as "access_level" from japb_user where username = $1 or email_address = $1;',
